    ...
    resources: {
        en: {
            translation: {
                ...
                messages: {
                    welcome: "Welcome to RB (Powered by Quantum Blue AI)",
                    loading: "Loading...",
        ...
        my: { // Burmese
            translation: {
                ...
                messages: {
                    welcome: "RB သို့ ကြိုဆိုပါသည် (Quantum Blue AI မှ ပံ့ပိုးသည်)",
                    loading: "ဖွင့်နေသည်...",
        ...
        hi: { // Hindi
            translation: {
                ...
                messages: {
                    welcome: "आरबी में आपका स्वागत है (क्वांटम ब्लू AI द्वारा संचालित)",
        ...
        te: { // Telugu
            translation: {
                ...
                messages: {
                    welcome: "RB కు స్వాగతం (క్వాంటమ్ బ్లూ AI ద్వారా నడుపబడుతుంది)",
